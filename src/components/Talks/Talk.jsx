...
const Talk = () => {
  return (
    <div className="bg-gradient-to-r from-blue-100 to-blue-300 mt-32 px-4 py-12">
      <div className="grid sm:grid-cols-2 items-center gap-16 my-6 mx-auto max-w-5xl">
        <div>
          <h1 className="md:text-4xl text-3xl font-extrabold text-blue-800">
            Let's Talk
          </h1>
          <p className="mt-6 text-gray-700">
            Have a big idea or brand to develop and need help? Reach out, we'd
            love to hear about your project and provide support.
          </p>
          <div className="mt-12">
          ...
          <div className="mt-12">
            <h2 className="text-xl font-semibold text-blue-700">Socials</h2>
        ...
        <div className="bg-blue-100 border border-blue-300 rounded-lg p-6">
          <h2 className="text-xl font-semibold text-blue-800">Contact Us</h2>
          <form
